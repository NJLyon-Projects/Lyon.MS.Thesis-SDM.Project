...
##  ---------------------------------------  ##
# Re-reset the working directory
setwd("~/Documents/School/1. Iowa State/_MS Project/-Thesis Chapters/Chapter 3 - SDMs/Chap 3 Figures/Lyon_Chap3_D13 Figs/Supplementary Figures")

# Supplementary Figure 1. C3 Grass Current
emf(file = "./SupFig1.emf", bg = "white", width = 7, height = 7, family = "Calibri", coordDPI = 350)
plot(c3.pos, legend = F, col = grass.cols, bty = 'n', box = F, axes = F)
legend("left", title = "Current", legend = rev(c(0:3)), fill = rev(grass.cols), bty = 'n')
sp::plot(countries, add = T, border = 'black')
sp::plot(states, add = T, border = 'black')
sp::plot(lakes, add = T, col = 'white')
dev.off()

# Supplementary Figure 2. C4 Grass Current
emf(file = "./SupFig2.emf", bg = "white", width = 7, height = 7, family = "Calibri", coordDPI = 350)
...
# Supplementary Figure 3. Forb Current
emf(file = "./SupFig3.emf", bg = "white", width = 7, height = 7, family = "Calibri", coordDPI = 350)
plot(forb.pos, legend = F, col = forb.cols, bty = 'n', box = F, axes = F)
legend("left", title = "Current", legend = rev(c(0:6)), fill = rev(forb.cols), bty = 'n')
sp::plot(countries, add = T, border = 'black')
sp::plot(states, add = T, border = 'black')
sp::plot(lakes, add = T, col = 'white')
dev.off()

# Supplementary Figure 4. Legume Current
emf(file = "./SupFig4.emf", bg = "white", width = 7, height = 7, family = "Calibri", coordDPI = 350)
plot(leg.pos, legend = F, col = leg.cols, bty = 'n', box = F, axes = F)
legend("left", title = "Current", legend = rev(c(0:2)), fill = rev(leg.cols), bty = 'n')
sp::plot(countries, add = T, border = 'black')
sp::plot(states, add = T, border = 'black')
sp::plot(lakes, add = T, col = 'white')
dev.off()
