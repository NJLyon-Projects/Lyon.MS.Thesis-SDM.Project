...
spnames <- c('Stipa spartea', 'Hesperostipa spartea ', 'Stipa robusta', 'Hesperostipa spartea')
...
# Save it!
saveRDS(records, './Species Records/STISPA V1 - Initial Records Pull.rds')
...
saveRDS(records, './Species Records/STISPA V2 - Records & Env.rds')
...
predictors <- c('WC08', 'WC09', 'WC16', 'WC17')
...
save(randomBg, file = './Species Records/STISPA - Random BG.Rdata', compress = T)
...
# Save that model
save(manualSelectModel, file = './Preliminary Models/STISPA Model V1 - Manual Predictors.Rdata', compress = T)

# Predict the model across the landscape
manualSelectMap <- predict(manualSelectModel, climate,
                           filename = './Preliminary Models/STISPA Map V1 - Manual Predictors.Rdata',
...
# Save!
save(envThinModel, file = './Preliminary Models/STISPA Model V2 - Env Thinned.Rdata', compress = T)

# Write current raster
envThinMap <- predict(envThinModel, climate, 
                      filename = './Preliminary Models/STISPA Map V2 - Env Thinned',
                      format = 'GTiff', overwrite = T)
...
save(baselineModel, file = './Preliminary Models/STISPA Model V3 - Baseline.Rdata', compress = T)

# And get a map of it
baselineMap <- predict(baselineModel, climate,
                       filename = './Preliminary Models/STISPA Map V3 - Baseline',
                       format = 'GTiff', overwrite = T)

# And also plot it in a save function
jpeg(filename = './Maps/Current Maps/STISPA Current.jpg', width = 1080, height = 1138, quality = 100)
plot(baselineMap, main = 'STISPA Complete')
sp::plot(countries, add = T, border = 'gray45')
sp::plot(states, add = T, border = 'gray45')
dev.off()

# Just for fun, where are your chosen records from?
jpeg(filename = './Maps/Current Maps/STISPA Occ.jpg', width = 1080, height = 1138, quality = 100)
plot(recordsSpatial, main = 'STISPA')
...
for (i in 1:5) {
  ...
  save(model, file = paste0('./Preliminary Models/All Spp - K Folds/STISPA - K fold ', i, '.Rdata'),
       compress = T)
...
future45BaselineMap <- predict(baselineModel, cc45.pred, 
                               filename = './Future Models/STISPA - CC 45',
                               format = 'GTiff', overwrite = T)

# Plot it
jpeg(filename = './Maps/Future Maps/STISPA CC 45.jpg', width = 1080, height = 1138, quality = 100)
plot(future45BaselineMap, main = 'STISPA CC 4.5')
sp::plot(countries, add = T, border = 'gray45')
sp::plot(states, add = T, border = 'gray45')
dev.off()
...
jpeg(filename = './Maps/MESS Maps/STISPA CC 45 MESS.jpg', width = 1080, height = 1138, quality = 100)
plot(extrapMap45, main = 'STISPA MESS CC 4.5')
...
future85BaselineMap <- predict(baselineModel, cc85.pred, 
                               filename = './Future Models/STISPA - CC 85',
                               format = 'GTiff', overwrite = T)

# Plot it
jpeg(filename = './Maps/Future Maps/STISPA CC 85.jpg', width = 1080, height = 1138, quality = 100)
plot(future85BaselineMap, main = 'STISPA CC 4.5')
sp::plot(countries, add = T, border = 'gray45')
sp::plot(states, add = T, border = 'gray45')
dev.off()
...
# Save once it is generated
jpeg(filename = './Maps/MESS Maps/STISPA CC 85 MESS.jpg', width = 1080, height = 1138, quality = 100)
plot(extrapMap85, main = 'STISPA MESS CC 4.5')
sp::plot(countries, add = T)
sp::plot(states, add = T)
dev.off()
